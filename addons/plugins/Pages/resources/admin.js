var AdminProfiles = {
	...
	showEditSheet: function(fieldId, formData) {
		ETSheet.loadSheet("editFieldSheet", "admin/pages/edit.view/"+fieldId, function() {
	...
	showCreateSheet: function(formData) {
		ETSheet.loadSheet("editFieldSheet", "admin/pages/create.view/", function() {
