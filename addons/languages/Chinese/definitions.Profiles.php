<?php
$definitions["Profiles"] = "用户资料";
$definitions["About"] = "关于成员";
$definitions["Create Field"] = "创建选项";
$definitions["Edit Field"] = "编辑选项";
$definitions["Field description"] = "编辑描述";
$definitions["Field name"] = "选项名";
$definitions["Hide field from guests"] = "对游客";
$definitions["Input type"] = "选择类型";
$definitions["Location"] = "位置";
$definitions["Manage Profile Fields"] = "管理选项";
$definitions["Options"] = "选择";
$definitions["Privacy"] = "隐私";
$definitions["Show field on posts"] = "在帖子的顶部显示";
$definitions["Hide field from guests"] = "对游客隐藏";
$definitions["Searchable in member list"] = "添加到会员列表搜索";
